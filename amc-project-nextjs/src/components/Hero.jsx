                    ...
                    >
                        <div className="max-w-7xl w-full px-8 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            <div className="space-y-6 z-10">
                                ...
                                >
                                    <Link href="/contact" className="inline-block bg-white text-blue-900 px-8 py-3 rounded-full font-bold text-lg hover:bg-blue-50 transition shadow-lg">
                                        Get a Quote
                                    </Link>
                                </motion.div>
                            </div>
