...
export default function PlanDetails({ params }) {
    ...
    const plan = plans.find(p => p.id === resolvedParams.id);
    ...
    return (
        <div className="min-h-screen pt-10 pb-20 px-4 max-w-7xl mx-auto">
            <Link href="/#plans" className="inline-flex items-center text-primary-600 hover:text-primary-700 mb-8 group font-medium">
