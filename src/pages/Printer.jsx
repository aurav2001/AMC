...
const Printer = () => {
    ...
    const services = content.printer?.services || [];
    const softwareList = content.printer?.softwareList || [];
    const stats = content.printer?.stats || [];
    const hero = content.printer?.hero || {};
    ...
    return (
        <div className="bg-slate-50 min-h-screen">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                                {hero.title || 'Complete Printer Solutions'}
                            </h1>
                            <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                                {hero.subtitle || 'From printer installation to maintenance and repair, we provide comprehensive printer support services for your business.'}
                            </p>
            ...
            <WhyUs data={{
                badge: content.printer?.whyChooseUs?.badge,
                title: content.printer?.whyChooseUs?.heading,
                subtitle: content.printer?.whyChooseUs?.subtitle,
                reasons: content.printer?.whyChooseUs?.reasons,
                rightCard: {
                    title: content.printer?.whyChooseUs?.ctaHeading,
                    description: content.printer?.whyChooseUs?.ctaDescription,
                    features: content.printer?.whyChooseUs?.features,
                    phone: content.printer?.hero?.phone
                },
